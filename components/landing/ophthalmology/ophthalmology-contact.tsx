...
export function OphthalmologyContact({ contact, cta }: { contact?: ContactSettings; cta?: CTASettings }) {
  ...
  return (
    <section
      id="contact"
      ref={containerRef}
      className="relative overflow-hidden pt-10 lg:pt-12 pb-14 lg:pb-20 bg-white dark:bg-slate-950"
    >
      ...
      <div className={cn("mx-auto px-4 lg:px-8 relative z-10 w-full", OPHTHALMOLOGY_MAX_WIDTH)}>
        
        {/* Header content */}
        <div className="flex flex-col items-center text-center mb-6">
            <motion.div 
               initial={reduced ? {} : { opacity: 0, scale: 0.8 }} animate={reduced || !isInView ? {} : { opacity: 1, scale: 1 }}
               className="inline-flex items-center px-4 py-1.5 rounded-full bg-teal-50 dark:bg-teal-900/20 text-teal-500 text-[10px] font-black uppercase tracking-widest mb-4"
            >
               {t("badge")}
            </motion.div>
            
            <h2 className={cn("text-3xl lg:text-4xl font-black text-slate-900 dark:text-white leading-[1.1] mb-4 break-words", OPHTHALMOLOGY_FONT_HEADING)}>
          ...
          <div className="bg-white dark:bg-[#0B0B1E] rounded-3xl overflow-hidden border border-slate-200/60 dark:border-slate-800/60 p-6 sm:p-8">
            ...
            {/* Message Form (Top Section) */}
               <div className="flex items-center gap-4 mb-6">
                  <div className="w-10 h-10 rounded-3xl bg-teal-500/10 flex items-center justify-center text-teal-500">
               ...
               >
                  <div className="space-y-1.5">
                     ...
                     <div className="relative group">
                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400 dark:text-slate-500 group-focus-within:text-teal-500 transition-colors" />
                        <Input
                           id="contact-name"
                           name="name"
                           placeholder={t("fullNamePlaceholder")}
                           required
                           className="h-10 pl-11 rounded-xl border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-white/5 text-slate-900 dark:text-white text-xs placeholder:text-slate-300 dark:placeholder:text-slate-700 focus-visible:ring-teal-500/50 transition-all border-2"
                        />
                     </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                     ...
                     <div className="relative group">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400 dark:text-slate-500 group-focus-within:text-teal-500 transition-colors" />
                        <Input
                           id="contact-email"
                           name="email"
                           type="email"
                  ...
                  <div className="sm:col-span-2 space-y-1.5">
                     ...
                     <div className="relative group">
                        <MessageCircle className="absolute left-4 top-4 w-3.5 h-3.5 text-slate-400 dark:text-slate-500 group-focus-within:text-teal-500 transition-colors" />
                        <Textarea
                           id="contact-message"
                           name="message"
                           required
                           ...
                           rows={3}
                           className="p-4 pl-11 rounded-xl border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-white/5 text-slate-900 dark:text-white text-xs focus-visible:ring-teal-500/50 transition-all border-2 resize-none"
                        />
                     </div>
                  </div>
                  ...
                  <div className="sm:col-span-2 pt-2 flex justify-start">
                     <LandingButton
                        ...
                        variant="primary"
                        disabled={loading}
                        className="h-10 px-8 rounded-full text-xs font-black !bg-teal-500 hover:!bg-teal-600 dark:!bg-teal-500 dark:hover:!bg-teal-600 text-white border-none transition-all active:scale-[0.98] group/btn"
                     >
                        {loading ? (
