          ...
          <div className="w-full lg:w-auto flex flex-col sm:flex-row gap-4 flex-1 max-w-2xl items-stretch">
            <div className="flex-1 relative">
               ...
               <input 
                 ...
                 className="w-full h-14 bg-white/10 border border-white/20 rounded-xl pl-12 pr-4 text-white outline-none focus:border-rose-500 transition-all font-medium placeholder:text-slate-400"
               />
            </div>
            <button className="h-14 px-8 rounded-xl bg-rose-500 text-white font-black hover:bg-rose-600 transition-all flex items-center justify-center gap-2 whitespace-nowrap active:scale-95">
               Subscribe Now
