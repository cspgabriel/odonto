...
export function AppointmentHero() {
  ...
  return (
    <section className="relative overflow-hidden pt-36 pb-24 lg:pt-52 lg:pb-48 bg-[#FFF2F6] dark:bg-slate-900/50 px-4">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-rose-100/50 dark:bg-rose-900/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3 -z-10"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
             <motion.div 
               ...
               className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-100/50 dark:bg-rose-900/30 text-rose-500 text-sm font-black uppercase tracking-[0.2em] mb-8"
             >
             ...
             <motion.h1 
               ...
               animate={h1Animate}
               transition={h1Trans}
               className={cn("text-5xl sm:text-7xl lg:text-8xl font-black text-[#2D2D5F] dark:text-white leading-[1.05] mb-10 break-words", DENTAL_FONT_HEADING)}
             >
               {t("title")}
             </motion.h1>
             ...
             >
               <Link href="/" className="flex items-center gap-2 text-rose-500 font-black hover:text-rose-600 transition-colors bg-white/80 dark:bg-slate-800/80 px-4 py-2 rounded-xl shadow-sm">
          ...
          <div className="flex-1 relative w-full max-w-[500px]">
             ...
             >
                ...
                >
                   <Image src={LANDING_IMAGES.doctor2} alt="Icon" width={100} height={100} className="rounded-2xl object-cover h-full" />
                </motion.div>

                {/* Decorative Circle Dot */}
                <div className="absolute -bottom-4 right-1/4 w-8 h-8 bg-rose-500 rounded-full animate-ping opacity-20"></div>
             </motion.div>
          </div>
