...
export function AppointmentFeatures() {
  ...
  return (
    <section className="relative pt-16 pb-16 px-4">
      <div className={cn("mx-auto mb-16", DENTAL_MAX_WIDTH)}>
        <motion.div 
          initial={headerInitial}
          animate={headerAnimate}
          className="text-center"
        >
          <h1 className={cn("text-4xl lg:text-7xl font-black text-[#2D2D5F] dark:text-white mb-6 break-words", DENTAL_FONT_HEADING)}>
            {t("title")}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {FEATURES.map((card, idx) => (
            ...
            >
              ...
              <h3 className={cn("text-3xl font-black mb-6 pe-12 leading-tight", DENTAL_FONT_HEADING)}>
                {card.title}
              </h3>
              ...
              <div className="flex items-center justify-between mt-auto">
                <div className={cn(
                  ...
                  card.variant === "dark" ? "text-white" : "text-rose-500"
                )}>
                  {card.readMore}
                ...
                <div className={cn(
                  ...
                  card.variant === "dark" ? "bg-white/10 text-white" : "bg-rose-50 text-rose-500 dark:bg-rose-900/20"
                )}>
