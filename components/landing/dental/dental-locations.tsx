...
export function DentalLocations() {
      ...
      <div className={cn("mx-auto relative z-10", DENTAL_MAX_WIDTH)}>
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
                ...
                <div className="absolute inset-0 pointer-events-none flex items-start justify-end p-6">
                   ...
                   >
                      <button 
                        ...
                        className="absolute top-4 right-4 w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-400 hover:text-rose-500 transition-colors"
                      >
                         <X className="w-4 h-4" />
                      </button>
                      ...
                      <div className="flex items-center gap-2 mb-6">
                         ...
                         <div className="flex flex-col">
                            ...
                            <span className="text-rose-500 font-bold text-[10px] uppercase tracking-widest leading-none mt-0.5">Master</span>
                         </div>
                      </div>
          ...
          <div className="lg:col-span-12 xl:col-span-4 flex flex-col">
             <div className="mb-6">
                <span className="text-rose-500 font-black text-xs uppercase tracking-[0.2em] mb-2 block text-center lg:text-left">{t("badge")}</span>
                <h2 className={cn("text-3xl lg:text-4xl font-black text-[#2D2D5F] dark:text-white leading-tight mb-4 text-center lg:text-left break-words", DENTAL_FONT_HEADING)}>
             ...
             <div className="grid grid-cols-1 gap-4">
                {LOCATIONS.map((loc, idx) => (
                   <motion.div 
                     ...
                     className="group relative p-4 bg-white dark:bg-slate-800 rounded-[20px] border border-slate-100 dark:border-slate-700 hover:border-rose-200 dark:hover:border-rose-900/50 transition-all flex flex-col h-fit shadow-none cursor-pointer"
                   >
                      <div>
                      ...
                      <div className="pt-3 mt-4 border-t border-slate-50 dark:border-slate-700 flex items-center justify-between">
                         <button className="flex items-center gap-2 text-rose-500 font-black text-[9px] uppercase tracking-widest hover:text-rose-600 transition-colors group/btn">
                            {t("getDirections")}
                            <Navigation className="w-3 h-3 group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
                         </button>
                         <div className="w-8 h-8 rounded-lg bg-slate-50 dark:bg-slate-700/50 flex items-center justify-center text-slate-400 group-hover:bg-rose-500 group-hover:text-white transition-all">
