...
export function DentalSmileComparison({ smileComparison }: { smileComparison?: ContentSettings["smileComparison"] }) {
    ...
    >
      <div className={cn("mx-auto px-4 relative z-10", DENTAL_MAX_WIDTH)}>
        ...
        <div className="flex flex-col items-center text-center mb-6 md:mb-8">
            <h2 className={cn("text-2xl md:text-4xl lg:text-5xl font-black text-slate-900 dark:text-white leading-tight px-4 break-words", DENTAL_FONT_HEADING)}>
        ...
        <div className="mt-6 md:mt-8 flex justify-center">
          <motion.div 
            ...
            animate={animateY}
            transition={trans}
            className="group relative w-full max-w-4xl overflow-hidden rounded-2xl md:rounded-[40px] bg-white dark:bg-slate-800 border-4 md:border-8 border-white dark:border-slate-800 shadow-2xl shadow-rose-500/5"
          >
