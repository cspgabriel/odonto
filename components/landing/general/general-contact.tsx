...
export function GeneralContact({ contact, cta }: { contact?: ContactSettings; cta?: CTASettings }) {
      ...
      <div className={cn("mx-auto px-4 relative z-10", GENERAL_MAX_WIDTH)}>
        ...
        <div className={cn("flex flex-col items-center text-center", GENERAL_HEADER_CONTENT_GAP)}>
            <motion.div 
               ...
               className="inline-flex items-center px-4 py-1.5 rounded-full bg-primary/10 dark:bg-primary/20 text-primary text-[10px] font-black uppercase tracking-widest mb-4"
            >
               {t("badge")}
            </motion.div>
           ...
           <motion.p 
             ...
             className={cn("max-w-xl", GENERAL_SECTION_DESCRIPTION)}
           >
             {t("subtitle")}
           </motion.p>
        </div>
               ...
               >
                  <div className="space-y-1.5">
                     ...
                     <div className="relative group">
                        <User className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400 dark:text-slate-500 group-focus-within:text-primary transition-colors" />
                        <Input
                           id="contact-name"
                           name="name"
                           placeholder={t("fullNamePlaceholder")}
                           required
                           className="h-10 pl-11 rounded-xl border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-white/5 text-slate-900 dark:text-white text-xs placeholder:text-slate-300 dark:placeholder:text-slate-700 focus-visible:ring-primary/50 transition-all border-2"
                        />
                     </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                     ...
                     <div className="relative group">
                        <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400 dark:text-slate-500 group-focus-within:text-primary transition-colors" />
                        <Input
                           id="contact-email"
                           name="email"
                           type="email"
                  ...
                  <div className="sm:col-span-2 space-y-1.5">
                     ...
                     <div className="relative group">
                        <MessageCircle className="absolute left-4 top-4 w-3.5 h-3.5 text-slate-400 dark:text-slate-500 group-focus-within:text-primary transition-colors" />
                        <Textarea
                           id="contact-message"
                           name="message"
                           required
                           ...
                           rows={3}
                           className="p-4 pl-11 rounded-xl border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-white/5 text-slate-900 dark:text-white text-xs focus-visible:ring-primary/50 transition-all border-2 resize-none"
                        />
                     </div>
                  </div>
                  ...
                  <div className="sm:col-span-2 pt-2 flex justify-start">
                     <LandingButton
                        ...
                        variant="primary"
                        disabled={loading}
                        className="h-10 px-8 rounded-lg text-xs font-black text-white border-none transition-all active:scale-[0.98] group/btn bg-gradient-to-r bg-primary hover:bg-primary/90 dark:bg-primary dark:hover:bg-primary/90 text-primary-foreground"
                     >
                        {loading ? (
