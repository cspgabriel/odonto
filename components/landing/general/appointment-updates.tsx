      ...
      <div className={cn("mx-auto px-4 relative z-10", GENERAL_MAX_WIDTH)}>
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
             <div className="w-16 h-16 rounded-full bg-[#0cc0df]/20 flex items-center justify-center text-[#0cc0df] shrink-0">
          ...
          <div className="w-full lg:w-auto flex flex-col sm:flex-row gap-4 flex-1 max-w-2xl items-stretch">
            <div className="flex-1 relative">
               ...
               <input 
                 ...
                 className="w-full h-14 bg-white/10 border border-white/20 rounded-xl pl-12 pr-4 text-white outline-none focus:border-[#0cc0df] transition-all font-medium placeholder:text-slate-400"
               />
            </div>
            <button className="h-14 px-8 rounded-xl bg-[#0cc0df] text-white font-black hover:bg-[#0aa5c4] transition-all flex items-center justify-center gap-2 whitespace-nowrap active:scale-95">
               Subscribe Now
