...
export function AppointmentFeatures() {
  ...
  return (
    <section className="relative pt-16 pb-16 px-4">
      <div className={cn("mx-auto mb-16", GENERAL_MAX_WIDTH)}>
        <motion.div 
          initial={headerInitial}
          animate={headerAnimate}
          className="text-center"
        >
          <h1 className={cn("text-4xl lg:text-7xl font-black text-[#2D2D5F] dark:text-white mb-6 break-words", GENERAL_FONT_HEADING)}>
            {t("title")}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {FEATURES.map((card, idx) => (
            <motion.div
              ...
              className={cn(
                "group relative rounded-3xl p-10 flex flex-col h-full transform transition-all duration-500 hover:-translate-y-2 cursor-pointer",
                card.variant === "dark" 
                  ? "bg-[#2D2D5F] text-white" 
            ...
            >
              ...
              <h3 className={cn("text-3xl font-black mb-6 pe-12 leading-tight", GENERAL_FONT_HEADING)}>
                {card.title}
              </h3>
              ...
              <div className="flex items-center justify-between mt-auto">
                <div className={cn(
                  ...
                  card.variant === "dark" ? "text-white" : "text-primary"
                )}>
                  {card.readMore}
                ...
                <div className={cn(
                  ...
                  card.variant === "dark" ? "bg-white/10 text-white" : "bg-primary/10 text-primary dark:bg-primary/20"
                )}>
