      ...
      <div className="flex flex-col sm:flex-row items-center w-full gap-3">
        ...
        <div className="flex w-full sm:w-auto shrink-0 items-center gap-2">
          <div className="shrink-0 flex-1 sm:flex-none">
            <Label className="sr-only">{t("categoryFilter")}</Label>
            <Select
              value={searchParams.get("category") ?? "all"}
              onValueChange={(v) => updateQuery({ category: v === "all" ? "" : v })}
            >
              ...
              <SelectContent className="rounded-xl border-slate-200 dark:border-slate-800">
                ...
                <SelectItem value="equipment" className="cursor-pointer font-medium text-xs">
                  {t("categoryEquipment")}
                </SelectItem>
                <SelectItem value="consumables" className="cursor-pointer font-medium text-xs">
                  {t("categoryConsumables")}
                </SelectItem>
                <SelectItem value="medications" className="cursor-pointer font-medium text-xs">
                  {t("categoryMedications")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="shrink-0 flex-1 sm:flex-none">
            ...
            >
              ...
              <SelectContent className="rounded-xl border-slate-200 dark:border-slate-800">
                ...
                <SelectItem value="in_stock" className="cursor-pointer font-medium text-xs">
                  {t("statusInStock")}
                </SelectItem>
                <SelectItem value="low_stock" className="cursor-pointer font-medium text-xs">
                  {t("statusLowStock")}
                </SelectItem>
                <SelectItem value="out_of_stock" className="cursor-pointer font-medium text-xs">
                  {t("statusOutOfStock")}
                </SelectItem>
              </SelectContent>
            </Select>
            ...
            <div className="flex items-center gap-1 shrink-0">
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  router.push(`/dashboard/inventory?page=1&pageSize=${pageSize}`);
                }}
              >
                {tCommon("clear")}
              </Button>
