...
export function ServiceSearch({
  ...
  const updateQuery = useCallback(
    (updates?: { q?: string; department?: string; status?: string }) => {
      ...
      if (updates && "department" in updates) {
        if (updates.department) params.set("department", updates.department);
        ...
        <div className="flex w-full sm:w-auto shrink-0 items-center gap-2">
          <div className="shrink-0 flex-1 sm:flex-none">
            ...
            <Select
              ...
              onValueChange={(v) =>
                updateQuery(v === "all" ? { department: "" } : { department: v })
              }
            >
          ...
          <div className="shrink-0 flex-1 sm:flex-none">
            ...
            <Select
              ...
              onValueChange={(v) =>
                updateQuery(v === "all" ? { status: "" } : { status: v })
              }
            >
          ...
          {hasFilters && (
            <Button
              ...
              onClick={() => {
                setValue("");
                onClearSelection?.();
                router.push("/dashboard/services?page=1&pageSize=" + pageSize);
              }}
            >
              {tCommon("clear")}
            </Button>
