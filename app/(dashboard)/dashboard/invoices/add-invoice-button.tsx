...
import { CreateNewInvoiceForm } from "./new/create-new-invoice-form";
        ...
        >
          <SheetHeader className="p-6 pb-4 border-b border-slate-200/60 dark:border-slate-800/60 bg-slate-50/50 dark:bg-slate-900/50 shrink-0">
            ...
            <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 mt-1">
              {t("createNewInvoiceDescription")}
            </p>
          </SheetHeader>
          <div className="flex-1 overflow-y-auto p-6">
            <CreateNewInvoiceForm onSuccess={() => setOpen(false)} />
          </div>
        </SheetContent>
      </Sheet>
    </>
