...
function toTime(d: Date | string): string {
  const date = toDate(d);
...
export function EditAppointmentForm({
  ...
  doctors: { id: string; fullName: string; specialization: string | null; departmentName: string | null }[];
  ...
  const {
    ...
    defaultValues: {
      ...
      startDate: toDate(appointment.startTime),
      startTime: toTime(appointment.startTime),
      endDate: toDate(appointment.endTime),
      endTime: toTime(appointment.endTime),
  ...
  useEffect(() => {
    ...
    setValue("serviceId", appointment.serviceId ?? null);
    setValue("startDate", toDate(appointment.startTime));
    setValue("startTime", toTime(appointment.startTime));
    setValue("endDate", toDate(appointment.endTime));
    setValue("endTime", toTime(appointment.endTime));
